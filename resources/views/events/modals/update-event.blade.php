<div class="modal fade" id="eventsModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="{{ route('event.updateEvent') }}">
                    @csrf
                    @method('PUT')
                    <div>
                    ...
                    <div class="mt-4">
                        ...
                        <input type="hidden" id="id_event" value="1" name="id">
                        <input type="checkbox" name="completed_event" id="completed_event">
                        <label for="completed_event">Completed</label>
                    </div>
                    <button type="submit" class="btn btn-primary mb-1 mt-3">Update Event</button><br>
                    <button type="button" class="btn btn-secondary mb-1" data-bs-dismiss="modal">Close</button>
                </form>

                <form method="POST" id="deleteFormEvent">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-danger delete-button-event">Delete</button>
                </form>
            </div>
        </div>
    </div>
